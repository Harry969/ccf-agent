...
- Algorithm chapter skills that can be swapped per paper or venue.
...
- `chapter_skill`: algorithm-chapter guidance that adapts the generic template to a paper's section shape.
