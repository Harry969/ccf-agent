...
1. Fill a JSON config with the target paper, model profile, LaTeX template, chapter skill, style skill, and few-shot file.
...
- Use `templates/latex/method-chapter.tex` as the generic method-section starting point when drafting a new algorithm chapter.
- Run the harness.
